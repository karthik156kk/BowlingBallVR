...
var Camera = class _Camera extends Node {
  ...
  constructor(name66, position, scene, setActiveOnSceneIfNoneActive = true) {
    ...
    this.renderPassId = this.getScene().getEngine().createRenderPassId(`Camera ${name66}`);
  }
  /**
   ...
   * @internal
   */
  setCameraRigParameter(name66, value) {
    if (!this._cameraRigParams) {
      this._cameraRigParams = {};
    }
    this._cameraRigParams[name66] = value;
    if (name66 === "interaxialDistance") {
  ...
  clone(name66, newParent = null) {
    const camera = SerializationHelper.Clone(_Camera.GetConstructorFromName(this.getClassName(), name66, this.getScene(), this.interaxialDistance, this.isStereoscopicSideBySide), this);
    camera.name = name66;
   ...
   */
  // eslint-disable-next-line @typescript-eslint/naming-convention
  static GetConstructorFromName(type, name66, scene, interaxial_distance = 0, isStereoscopicSideBySide = true) {
    const constructorFunc = Node.Construct(type, name66, scene, {
      // eslint-disable-next-line @typescript-eslint/naming-convention
      interaxial_distance,
    ...
    return () => _Camera._CreateDefaultParsedCamera(name66, scene);
  }
  /**
...
var Material = class _Material {
   ...
   */
  constructor(name66, scene, doNotAdd) {
    ...
    this._uniformBuffer = new UniformBuffer(this._scene.getEngine(), void 0, void 0, name66);
...
var MultiMaterial = class _MultiMaterial extends Material {
   ...
   * @returns the cloned material
   */
  clone(name66, cloneChildren) {
    const newMultiMaterial = new _MultiMaterial(name66, this.getScene());
    for (let index = 0; index < this.subMaterials.length; index++) {
      let subMaterial = null;
      const current = this.subMaterials[index];
      if (cloneChildren && current) {
        subMaterial = current.clone(name66 + "-" + current.name);
      } else {
...
var Mesh = class _Mesh extends AbstractMesh {
   ...
   */
  constructor(name66, scene = null, parent = null, source = null, doNotCloneChildren, clonePhysicsImpostor = true) {
    super(name66, scene);
    ...
    if (source) {
      ...
      if (source._ranges) {
        ...
        for (const name67 in ranges) {
          if (!Object.prototype.hasOwnProperty.call(ranges, name67)) {
            continue;
          }
          if (!ranges[name67]) {
            continue;
          }
          this.createAnimationRange(name67, ranges[name67].from, ranges[name67].to);
        }
      }
      ...
      if (!doNotCloneChildren) {
        ...
        for (let index = 0; index < directDescendants.length; index++) {
          ...
          if (child.clone) {
            child.clone(name66 + "." + child.name, this);
          }
        }
      }
   ...
   * @returns a new mesh
   */
  clone(name66 = "", newParent = null, doNotCloneChildren, clonePhysicsImpostor = true) {
    return new _Mesh(name66, this.getScene(), newParent, this, doNotCloneChildren, clonePhysicsImpostor);
  }
  /**
  ...
  static _instancedMeshFactory(name66, mesh) {
  ...
  createInstance(name66) {
    return _Mesh._instancedMeshFactory(name66, this);
  }
  /**
   ...
   */
  static CreateRibbon(name66, pathArray, closeArray, closePath, offset, scene, updatable, sideOrientation, instance) {
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreateDisc(name66, radius, tessellation, scene, updatable, sideOrientation) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   * Creates a box mesh.
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreateBox(name66, size, scene, updatable, sideOrientation) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreateSphere(name66, segments, diameter, scene, updatable, sideOrientation) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreateHemisphere(name66, segments, diameter, scene) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreateCylinder(name66, height, diameterTop, diameterBottom, tessellation, subdivisions, scene, updatable, sideOrientation) {
    throw new Error("Import MeshBuilder to populate this function");
  }
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreateTorus(name66, diameter, thickness, tessellation, scene, updatable, sideOrientation) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreateTorusKnot(name66, radius, tube, radialSegments, tubularSegments, p, q, scene, updatable, sideOrientation) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   * Creates a line mesh..
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreateLines(name66, points, scene, updatable, instance) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreateDashedLines(name66, points, dashSize, gapSize, dashNb, scene, updatable, instance) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreatePolygon(name66, shape, scene, holes, updatable, sideOrientation, earcutInjection) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static ExtrudePolygon(name66, shape, depth, scene, holes, updatable, sideOrientation, earcutInjection) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static ExtrudeShape(name66, shape, path, scale, rotation, cap, scene, updatable, sideOrientation, instance) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static ExtrudeShapeCustom(name66, shape, path, scaleFunction, rotationFunction, ribbonCloseArray, ribbonClosePath, cap, scene, updatable, sideOrientation, instance) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   * Creates lathe mesh.
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreateLathe(name66, shape, radius, tessellation, scene, updatable, sideOrientation) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreatePlane(name66, size, scene, updatable, sideOrientation) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreateGround(name66, width, height, subdivisions, scene, updatable) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreateTiledGround(name66, xmin, zmin, xmax, zmax, subdivisions, precision, scene, updatable) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreateGroundFromHeightMap(name66, url, width, height, subdivisions, minHeight, maxHeight, scene, updatable, onReady, alphaFilter) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   * Creates a tube mesh.
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreateTube(name66, path, radius, tessellation, radiusFunction, cap, scene, updatable, sideOrientation, instance) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreatePolyhedron(name66, options, scene) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreateIcoSphere(name66, options, scene) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreateDecal(name66, sourceMesh, position, normal, size, angle) {
    throw new Error("Import MeshBuilder to populate this function");
  }
   ...
   * @deprecated Please use MeshBuilder instead
   */
  static CreateCapsule(name66, options, scene) {
    throw new Error("Import MeshBuilder to populate this function");
  }
  /**
...
var SceneLoader = class _SceneLoader {
  ...
  static _LoadData(fileInfo, scene, onSuccess, onProgress, onError, onDispose, pluginExtension, name66) {
    ...
    const manifestChecked = () => {
      ...
      request = plugin.loadFile ? plugin.loadFile(scene, fileInfo.rawData || fileInfo.file || fileInfo.url, fileInfo.rootUrl, dataCallback, onProgress, useArrayBuffer, errorCallback, name66) : scene._loadFile(fileInfo.file || fileInfo.url, dataCallback, onProgress, true, useArrayBuffer, errorCallback);
    };
    const engine = scene.getEngine();
   ...
   */
  static ImportMesh(meshNames, rootUrl, sceneFilename = "", scene = EngineStore.LastCreatedScene, onSuccess = null, onProgress = null, onError = null, pluginExtension = null, name66 = "") {
    if (!scene) {
    ...
    }, progressHandler, errorHandler, disposeHandler, pluginExtension, name66);
  }
  /**
   * Import meshes into a scene
   * @param meshNames an array of mesh names, a single mesh name, or empty string for all meshes that filter what meshes are imported
   ...
   */
  static ImportMeshAsync(meshNames, rootUrl, sceneFilename = "", scene = EngineStore.LastCreatedScene, onProgress = null, pluginExtension = null, name66 = "") {
    return new Promise((resolve, reject) => {
      _SceneLoader.ImportMesh(meshNames, rootUrl, sceneFilename, scene, (meshes, particleSystems, skeletons, animationGroups, transformNodes, geometries, lights) => {
        resolve({
          meshes,
          particleSystems,
          skeletons,
   ...
   * @returns The loaded plugin
   */
  static Load(rootUrl, sceneFilename = "", engine = EngineStore.LastCreatedEngine, onSuccess = null, onProgress = null, onError = null, pluginExtension = null, name66 = "") {
    if (!engine) {
      Tools.Error("No engine available");
      return null;
    }
    return _SceneLoader.Append(rootUrl, sceneFilename, new Scene(engine), onSuccess, onProgress, onError, pluginExtension, name66);
  }
  /**
   * Load a scene
   * @param rootUrl a string that defines the root url for the scene and resources or the concatenation of rootURL and filename (e.g. http://example.com/test.glb)
   ...
   */
  static LoadAsync(rootUrl, sceneFilename = "", engine = EngineStore.LastCreatedEngine, onProgress = null, pluginExtension = null, name66 = "") {
    return new Promise((resolve, reject) => {
   ...
   * @returns The loaded plugin
   */
  static Append(rootUrl, sceneFilename = "", scene = EngineStore.LastCreatedScene, onSuccess = null, onProgress = null, onError = null, pluginExtension = null, name66 = "") {
    if (!scene) {
   ...
   */
  static AppendAsync(rootUrl, sceneFilename = "", scene = EngineStore.LastCreatedScene, onProgress = null, pluginExtension = null, name66 = "") {
    return new Promise((resolve, reject) => {
   ...
   * @returns The loaded plugin
   */
  static LoadAssetContainer(rootUrl, sceneFilename = "", scene = EngineStore.LastCreatedScene, onSuccess = null, onProgress = null, onError = null, pluginExtension = null, name66 = "") {
    if (!scene) {
...
var name64 = "postprocessVertexShader";
var shader64 = `attribute vec2 position;uniform vec2 scale;varying vec2 vUV;const vec2 madd=vec2(0.5,0.5);
#define CUSTOM_VERTEX_DEFINITIONS
void main(void) {
#define CUSTOM_VERTEX_MAIN_BEGIN
...
var PostProcess = class _PostProcess {
  ...
  /** @internal */
  constructor(name66, fragmentUrl, parameters, samplers, _size, camera, samplingMode = 1, engine, reusable, defines = null, textureType = 0, vertexUrl = "postprocess", indexParameters, blockCompilation = false, textureFormat = 5, shaderLanguage = ShaderLanguage.GLSL) {
    this._parentContainer = null;
    this.width = -1;
    this.height = -1;
...
var name65 = "passPixelShader";
var shader65 = `varying vec2 vUV;uniform sampler2D textureSampler;
#define CUSTOM_FRAGMENT_DEFINITIONS
void main(void) 
{gl_FragColor=texture2D(textureSampler,vUV);}`;
ShaderStore.ShadersStore[name65] = shader65;
var passPixelShader = { name: name65, shader: shader65 };
...
Texture._CreateRenderTargetTexture = (name66, renderTargetSize, scene, generateMipMaps, creationFlags) => {
  return new RenderTargetTexture(name66, renderTargetSize, scene, generateMipMaps);
};
...
var AnimationGroup = class _AnimationGroup {
   ...
   */
  constructor(name66, scene = null, weight = -1, playOrder = 0) {
    this.name = name66;
   ...
   */
  static ClipKeys(sourceAnimationGroup, fromKey, toKey, name66, dontCloneAnimations) {
    const animationGroup = sourceAnimationGroup.clone(name66 || sourceAnimationGroup.name);
   ...
   */
  static ClipFrames(sourceAnimationGroup, fromFrame, toFrame, name66, dontCloneAnimations) {
    const animationGroup = sourceAnimationGroup.clone(name66 || sourceAnimationGroup.name);
...
//# sourceMappingURL=chunk-LTJHKGHY.js.map
