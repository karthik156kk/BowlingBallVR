...
} from "./chunk-44MHN7NZ.js";
import {
  Container3D,
  Control3D,
  GUI3DManager,
  Vector3WithInfo
} from "./chunk-NQUBVUCG.js";
import "./chunk-WOIMQK5L.js";
import {
  Animation,
  AnimationGroup,
  Constants,
...
var AdvancedDynamicTexture = class _AdvancedDynamicTexture extends DynamicTexture {
  ...
  clone(newName) {
    ...
    const clone = new _AdvancedDynamicTexture(newName ?? "Clone of " + this.name, size.width, size.height, scene, !this.noMipmap, this.samplingMode);
